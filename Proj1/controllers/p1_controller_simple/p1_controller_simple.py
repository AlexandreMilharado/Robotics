...
class Evolution:
    def __init__(self):
        self.evaluation_start_time = 0  # TODO
        self.collision = False          # TODO

        # Supervisor to reset robot position
        self.supervisor = Supervisor()          # TODO
        self.robot = self.supervisor.getSelf()  # TODO
   
        self.robot_node = self.supervisor.getFromDef("ROBOT")            # TODO
        self.translation_field = self.robot_node.getField("translation") # TODO
        self.rotation_field = self.robot_node.getField("rotation")       # TODO
        ...
        self.__n = 0                                                    # USELESS
        self.prev_position = self.supervisor.getSelf().getPosition()    # USELESS
